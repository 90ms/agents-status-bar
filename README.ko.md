...
`v0.1.0` 미리보기는 macOS 14 이상과 Apple Silicon을 지원합니다.
...
[Releases](https://github.com/90ms/agents-status-bar/releases)에서 `AgentsStatusBar-0.1.0.zip`을 내려받아 압축을 풀고 `Agents Status Bar.app`을 `/Applications`로 옮깁니다.
