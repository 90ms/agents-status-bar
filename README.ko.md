...
앱에 포함된 모델 단가는 공식 [OpenAI 모델 가격](https://developers.openai.com/api/docs/models)과 [Anthropic 가격](https://platform.claude.com/docs/en/about-claude/pricing)을 따릅니다. USD/KRW 환율은 [Frankfurter](https://frankfurter.dev/)의 ECB 제공자를 통해 한국 시간 기준 하루 한 번 확인합니다. 설정 화면에 적용 환율과 고시 기준일을 함께 표시하며, 주말이나 휴일에는 가장 최근 ECB 기준일의 환율이 사용될 수 있습니다.

## 설치

`v0.3.0` 미리보기는 macOS 14 이상과 Apple Silicon을 지원합니다.
...
[Releases](https://github.com/90ms/agents-status-bar/releases)에서 `AgentsStatusBar-0.3.0.zip`을 내려받아 압축을 풀고 `Agents Status Bar.app`을 `/Applications`로 옮깁니다.
