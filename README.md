...
- an animated menu-bar activity icon and per-provider indicator while local session files are being updated;
...
The `v0.4.1` preview requires macOS 14 or later and Apple silicon.
